...
> **Intelligent web application for club event management with role-based access control**
...
<table>
  <tr>
    <td>
      <img src="docs/screenshots/event_creation.png" alt="Event Creation Form"/>
      <p align="center"><em>Figure 5.3 – Event Creation Form</em></p>
    </td>
    <td>
      <img src="docs/screenshots/event_list.png" alt="Available Events"/>
      <p align="center"><em>Figure 5.5 – Available Events List</em></p>
    </td>
  </tr>
</table>
...
- **Role-Based Access**: Separate interfaces for organizers and participants
...
- GitHub: [@wahib-bachoua](https://github.com/wahib-bachoua)
- Repository: [gestionEvenements](https://github.com/wahib-bachoua/gestionEvenements)
...
- **Baeldung** - For comprehensive Spring tutorials
